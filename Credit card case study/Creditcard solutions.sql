...
--1. write a query to print the top 5 cities with the highest spends and their percentage contribution of total credit card spends 
...
order by 3 desc;              -- Females do more credit card transactions as compared to males.
